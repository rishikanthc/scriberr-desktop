    ...
    return (
        <div className="flex flex-col h-full overflow-hidden px-4">
            ...
            <div className="flex items-center justify-between mb-8 pt-6 shrink-0">
                ...
                <button
                    ...
                    className={clsx(
                        ...
                        isDirty
                            ? "bg-accent-primary border-accent-primary text-white shadow-[0_0_15px_var(--color-accent-glow)] hover:bg-accent-hover hover:shadow-[0_0_20px_rgba(255,140,0,0.5)] active:scale-95"
                            : "bg-glass-highlight border-glass-border text-white/20 cursor-not-allowed"
                    )}
            ...
            <div className="flex-1 flex flex-col gap-6 overflow-y-auto min-h-0 pb-6 scrollbar-hide">
                ...
                {/* Connection Card */}
                <div className="bg-glass-surface backdrop-blur-md border border-glass-border rounded-2xl p-6 shadow-xl flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="group relative">
                            <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest mb-1.5 block group-focus-within:text-accent-primary/80 transition-colors">Server URL</label>
                            <input
                                type="text"
                                value={url}
                                onChange={(e) => setUrl(e.target.value)}
                                className="w-full bg-glass-input border border-glass-border rounded-lg px-4 py-3 text-[15px] text-white placeholder-stone-600 focus:outline-none focus:border-accent-primary/50 focus:bg-glass-input/80 transition-all duration-300"
                        ...
                        {/* API Key Input */}
                        <div className="group relative">
                            <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest mb-1.5 block group-focus-within:text-accent-primary/80 transition-colors">API Key</label>
                            <input
                                type="password"
                                value={apiKey}
                                onChange={(e) => setApiKey(e.target.value)}
                                className="w-full bg-glass-input border border-glass-border rounded-lg px-4 py-3 text-[15px] text-white placeholder-stone-600 focus:outline-none focus:border-accent-primary/50 focus:bg-glass-input/80 transition-all duration-300 font-mono"
                                placeholder="sk-..."
                                spellCheck={false}
                            />
                        </div>
                ...
                <div className="bg-glass-surface backdrop-blur-md border border-glass-border rounded-2xl p-6 shadow-xl flex flex-col gap-6">
                    ...
                    <div className="flex gap-3">
                        <div className="flex-1 group relative">
                            ...
                            <div className="w-full bg-glass-input border border-glass-border rounded-lg px-4 py-3 text-[14px] text-stone-300 font-mono truncate min-h-[48px] flex items-center">
                                {outputPath || 'Default'}
                            </div>
                        </div>
                        <div className="flex flex-col justify-end">
                            <button
                                ...
                                className="bg-glass-highlight hover:bg-white/10 border border-glass-border text-stone-400 hover:text-white w-[48px] h-[48px] rounded-lg transition-all active:scale-95 flex items-center justify-center shrink-0"
                                title="Select Folder"
                            >
                                <Folder size={20} />
                            </button>
